...
library(corrplot)
#install.packages("lmtest")   # Prueba Durbin-Watson para comprobar independencia de los residuos
library(lmtest)               # También prueba Breusch-Pagan para la homoscedasticidad
#install.packages("nortest")  # Varias pruebas para verificar supuesto de normalidad en los residuos
library(nortest)
```
