...
**Suavización y pronóstico para el Producto A**
```{r}
# --------------------------------- PRODUCTO A --------------------------------- 
...
fcA = sma(productoA, order=3, h=4, silent=FALSE) # SmoothMovingAverage
summary(fcA)
...
**Suavización y pronóstico para el Producto B**
```{r}
pronos1A = ma(productoA, order=3) # Media móvil (serie, periodos hacia atrás)
plot(productoA)
lines(pronos1A, col="red")
...
**Suavización y pronóstico para el Producto C**
```{r}
pronos1A = ma(productoA, order=3) # Media móvil (serie, periodos hacia atrás)
plot(productoA)
lines(pronos1A, col="red")
